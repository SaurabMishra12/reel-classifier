...
import { addChangeListener, addErrorListener, clearShareIntent, getShareIntent, } from "./ExpoShareIntentModule";
...
//   3: "file",
// };
const parseShareIntent = (value, options) => {
    ...
    if (shareIntent.text) {
        ...
        const webUrl = shareIntent.text.match(/[(http(s)?)://(www.)?-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_+.~#?&//=]*)/gi)?.[0] || null;
        result = {
